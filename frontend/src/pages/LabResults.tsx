    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
          ...
          <p className="text-gray-500 mb-6">Add your first lab result to get started</p>
          <button
        ...
        <div className="grid gap-4">
          {labResults?.map((result: LabResult) => (
            <div key={result.id} className="bg-white rounded-2xl shadow-md border border-gray-100 p-5 hover:shadow-lg transition-all">
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">Normal Range</label>
                  <input
                    type="text"
